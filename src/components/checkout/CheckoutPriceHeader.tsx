  ...
  return (
    <div className="flex flex-col bg-white border-t border-[#f1f5f9] z-[1]">
      <div className="p-[12px_24px_24px_24px] flex flex-col gap-[10px]">
        ...
        {/* Coupon Application Status with Premium Gradient Border */}
        <div className="flex flex-col gap-[10px]">
          ...
          >
            <div className="flex items-center gap-[8px]">
              <DiscountIcon className="w-[18px] h-[18px] text-[#308026]" />
              <span className="font-titillium text-[16px] font-bold uppercase leading-[24px] text-[#308026] tracking-[0.5px]">
                {couponCode} Applied
              </span>
            </div>
            <span className="font-titillium text-[14px] font-semibold text-[#308026] tracking-[-0.2px]">
              Applied
            </span>
          </div>
          ...
          <div className="flex gap-[10px] justify-center items-center">
            ...
            <div className="font-titillium text-[15px] leading-[24px] text-[#242424]">
              Rs {couponDiscount} Saved with Coupon 
