    ...
    <div className="main-container mx-auto flex w-full max-w-[410px] flex-col justify-center items-center bg-white border-t border-[#f1f5f9] lg:max-w-none">
      <button 
        ...
        className={`flex w-full justify-between items-center px-[24px] transition-colors duration-300 ${
          isOpen ? 'bg-[#fafafb] py-[24px] pb-[16px]' : 'bg-white py-[24px]'
        }`}
      >
        ...
        {isOpen && (
          ...
          >
            <div className="flex flex-col gap-[20px] px-[24px] pb-[32px] pt-[24px] bg-white rounded-[24px_24px_0_0] border-b border-[#f1f5f9]">
              ...
              >
                <div className={`flex w-[16px] h-[16px] items-center justify-center rounded-[6px] transition-colors ${
                  isMarketing ? 'bg-[#308026]' : 'border border-[#eaebf0]'
                }`}>
