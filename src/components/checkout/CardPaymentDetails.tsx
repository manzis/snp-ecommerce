        ...
        >
            ...
            <div className="flex flex-col gap-3 opacity-20 pointer-events-none">
                <div className="flex flex-col gap-1.5">
                    <label className="font-rajdhani text-[12px] font-medium text-[#64748b] ml-1">Card Number</label>
                ...
                <div className="grid grid-cols-2 gap-3">
                    <div className="flex flex-col gap-1.5">
                        <label className="font-rajdhani text-[12px] font-medium text-[#64748b] ml-1">Expiry Date</label>
                    ...
                    <div className="flex flex-col gap-1.5">
                        <label className="font-rajdhani text-[12px] font-medium text-[#64748b] ml-1">CVC</label>
                        <div className="h-[48px] bg-white rounded-lg border border-[#e2e8f0] flex items-center px-3">
