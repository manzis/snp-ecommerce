...
export default function OrderFilters({ status: activeStatus, setStatus, hideCancelled, setHideCancelled }: OrderFiltersProps) {
                    ...
                    <>
                        ...
                        >
                            ...
                            <div className="flex items-center gap-2 mt-2">
                                ...
                                <button 
                                    onClick={() => { setStatus('all'); setHideCancelled(false); setIsFilterOpen(false); }}
