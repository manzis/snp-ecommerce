                        ...
                        >
                            <div>
                                ...
                                <div className="flex flex-col gap-1">
                                    {['All Sellers', 'Verified Only', 'Unverified'].map((status) => (
                                        <button key={status} className="text-left text-[14px] py-1.5 px-2 rounded-lg hover:bg-zinc-100 transition-colors text-[#242424]">
                                            {status}
                                        </button>
                                    ))}
                                </div>
                            ...
                            <div>
                                ...
                                <div className="flex flex-col gap-1">
                                    {['Name: A-Z', 'Name: Z-A', 'Highest Rating', 'Most Products'].map((sort) => (
