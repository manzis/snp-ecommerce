            ...
            <AnimatePresence>
                {isFilterOpen && (
                    <>
                        ...
                        >
                            <div>
                                <h3 className="text-[12px] font-semibold text-[#a1a1aa] uppercase tracking-wider mb-2">Origin</h3>
                                <div className="flex flex-col gap-1">
                                    {['All Brands', 'Local Brands', 'International Brands'].map((origin) => (
                                        <button key={origin} className="text-left text-[14px] py-1.5 px-2 rounded-lg hover:bg-zinc-100 transition-colors text-[#242424]">
                                            {origin}
                                        </button>
                                    ))}
                                </div>
                            ...
                            <div>
                                ...
                                <div className="flex flex-col gap-1">
                                    {['Name: A-Z', 'Name: Z-A', 'Most Products', 'Established Date'].map((sort) => (
