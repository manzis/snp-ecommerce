    ...
    return (
        <div className="relative" ref={menuRef}>
            <button
                onClick={toggleMenu}
                type="button"
                className={`flex w-[32px] h-[32px] items-center justify-center shrink-0 rounded-[8px] transition-colors duration-[150ms] ease-in-out cursor-pointer ${isOpen ? 'bg-[#242424] text-white' : 'bg-[#f4f4f5] text-[#242424] hover:bg-[#e4e4e7]'}`}
            ...
            <AnimatePresence>
                {isOpen && (
                    ...
                    >
                        <button
                            onClick={(e) => handleAction(e, () => onEdit?.(review))}
                        ...
                        <button
                            onClick={(e) => handleAction(e, () => onDelete?.(review.id))}
