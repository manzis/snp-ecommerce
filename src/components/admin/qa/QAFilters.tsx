            ...
            <AnimatePresence>
                {isFilterOpen && (
                    <>
                        ...
                        >
                            <div>
                                <h3 className="text-[12px] font-semibold text-[#a1a1aa] uppercase tracking-wider mb-2">Category</h3>
                                <div className="flex flex-col gap-1">
                                    {['All Questions', 'Product Details', 'Shipping', 'Pricing', 'Stock Info'].map((cat) => (
                                        <button key={cat} className="text-left text-[14px] py-1.5 px-2 rounded-lg hover:bg-zinc-100 transition-colors text-[#242424]">
                                            {cat}
                                        </button>
                                    ))}
                                </div>
                            ...
                            <div>
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {['All', 'Answered', 'Unanswered', 'Spam'].map((status) => (
