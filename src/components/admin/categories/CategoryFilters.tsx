            ...
            <AnimatePresence>
                {isFilterOpen && (
                    <>
                        ...
                        >
                            <div>
                                <h3 className="text-[12px] font-semibold text-[#a1a1aa] uppercase tracking-wider mb-2">Category Level</h3>
                                <div className="flex flex-col gap-1">
                                    {['All Levels', 'Parent Categories', 'Sub-Categories'].map((level) => (
                                        <button key={level} className="text-left text-[14px] py-1.5 px-2 rounded-lg hover:bg-zinc-100 transition-colors text-[#242424]">
                                            {level}
                                        </button>
                                    ))}
                                </div>
                            ...
                            <div>
                                ...
                                <div className="flex flex-col gap-1">
                                    {['Name: A-Z', 'Name: Z-A', 'Most Products', 'Recently Added'].map((sort) => (
                                        <button key={sort} className="text-left text-[14px] py-1.5 px-2 rounded-lg hover:bg-zinc-100 transition-colors text-[#242424]">
                                            {sort}
                                        </button>
                                    ))}
                                </div>
