            ...
            footerActions={
                <div className="grid grid-cols-2 gap-3 w-full">
                    <button
                        ...
                        className="flex items-center justify-center gap-2 px-4 py-3.5 bg-[#242424] text-white rounded-xl text-[12px] font-semibold hover:bg-black transition-all disabled:opacity-50 disabled:grayscale"
                    >
                    ...
                    <button
                        ...
                        className="flex items-center justify-center gap-2 px-4 py-3.5 bg-white border border-gray-200 text-[#242424] rounded-xl text-[12px] font-semibold hover:bg-gray-50 transition-all disabled:opacity-50"
                    >
