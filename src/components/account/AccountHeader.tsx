    ...
    return (
        <section className="flex flex-col items-center gap-[24px] w-full px-[24px] pt-[30px]">
            <div className="flex flex-col items-center gap-[12px] shrink-0">
                ...
                {/* GREETING */}
                <div className="font-titillium text-[22px] leading-[26px] tracking-[-0.4px] text-white whitespace-nowrap">
                ...
                <div className="flex gap-[8px] items-start shrink-0">
                    {/* EDIT BUTTON */}
                    <button className="flex h-[34px] w-[65px] items-center justify-center gap-[4px] rounded-[100px] bg-white transition-transform active:scale-95">
                    ...
                    {/* STORE BUTTON */}
                    <button className="flex h-[34px] w-[79px] items-center justify-center gap-[4px] rounded-[100px] bg-[#eaffcc] transition-transform active:scale-95">
