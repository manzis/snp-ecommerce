...
const ServiceHighlights: React.FC = () => {
  ...
  return (
    <section 
      className="main-container relative mx-auto flex w-full max-w-[700px] flex-col items-center bg-white border border-[#E9E9E9] rounded-[6px] p-[4px] gap-[4px] shrink-0 lg:mx-0 lg:max-w-none"
    >
      {/* 
          FRAME 167: Equal Distribution Row
          - items-stretch: Ensures all 3 divs have the same height (122px)
      */}
