    ...
    <section className="flex flex-col w-full bg-white border-t border-[#f1f5f9] px-[24px] py-[24px] relative">
      <div className="flex items-start justify-between">
        <div className="flex flex-col flex-1">
          ...
          <span className="font-titillium text-[16px] text-[#8a8e91] leading-[28px] tracking-[-0.6px]">
            {address}
          </span>
        </div>

        {/* Home Badge - Mobile Absolute / Desktop Static */}
        <div className="absolute top-[23px] left-[215px] lg:static flex h-[24px] w-[46px] items-center justify-center rounded-[6px] bg-[#e8f5e7] px-[6px]">
