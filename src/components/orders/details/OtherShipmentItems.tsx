        ...
        <section className="flex flex-col items-start gap-[16px] rounded-[16px] border border-[#e2e8f0] p-[16px]">
            <div className="flex flex-col gap-[16px] w-full">
                <div className="flex h-[32px] w-fit items-center justify-center gap-[10px] rounded-[6px] bg-[#f4ffeb] px-[8px]">
                    <h4 className="font-rajdhani text-[14px] font-[600] leading-[22px] tracking-[0.2px] text-[#242424]">
                        ...
                        <li key={idx} className="flex w-full items-center gap-[12px]">
                            ...
                            <div className="flex flex-1 flex-col gap-[4px]">
                                <div className="flex flex-col gap-[1px]">
                                    <span className="font-rajdhani text-[10px] font-[500] leading-[12px] text-[#242424]/80 uppercase">
                                        {item.products?.brands?.name || 'SNP Nutrition'}
                                    </span>
                                    <span className="font-rajdhani text-[12px] font-[600] leading-[18px] tracking-[0.2px] text-[#242424] line-clamp-1">
                                        {item.products?.name}
                                    </span>
                                </div>
                                <div className="flex flex-wrap items-center gap-[13px]">
                                    {item.selected_size && (
                                        <span className="font-rajdhani text-[12px] font-[500] leading-[16px] text-[#8a8e91]">Size : {item.selected_size}</span>
                                    )}
                                    {item.selected_flavor && (
                                        <span className="font-rajdhani text-[12px] font-[500] leading-[16px] text-[#8a8e91]">Flavour : {item.selected_flavor}</span>
                                    )}
            ...
            <div className="flex w-full items-center justify-between border-t border-[#e2e8f0] pt-[16px]">
                <div className="flex flex-col items-start">
                    <span className="font-rajdhani text-[12px] font-[500] leading-[16px] tracking-[0.2px] text-[#8b8e92]">
                        Total Amount
                    </span>
                ...
                >
                    <span className="font-rajdhani text-[13px] font-[600] text-[#308026]">
                        View Price Breakup
                    </span>
                </button>
            </div>
