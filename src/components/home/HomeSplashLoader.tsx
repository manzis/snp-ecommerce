...
export default function HomeSplashLoader() {
  ...
  return (
    <div
      ...
      aria-hidden="true"
      className={`fixed inset-0 z-[99999] flex flex-col items-center justify-center bg-[#081908] pointer-events-auto overflow-hidden transition-all duration-[1200ms] ease-in-out ${isLoading ? 'opacity-100 scale-100 blur-none' : 'opacity-0 scale-105 blur-[12px] pointer-events-none'}`}
    >
      ...
      <div
        className={`flex flex-col items-center justify-center gap-4 z-10 transition-all duration-1000 ease-out ${isLoading ? 'opacity-100 scale-100 blur-none' : 'opacity-0 scale-110 blur-[8px]'}`}
      >
        ...
        <div 
          className="flex flex-col items-center mt-4 animate-fade-in-up"
        >
