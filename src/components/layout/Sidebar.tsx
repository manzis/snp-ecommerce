...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, onClose }) => {
    ...
    const BrandsMarquee = () => {
        ...
        // Duplicate array enough times so it can scroll seamlessly using the generic -50% CSS animation
        ...
        return (
            <div className="flex overflow-hidden w-full pointer-events-none">
                <div 
                    className="h-full animate-marquee-ltr items-center"
                    style={{ animationDuration: '40s', gap: '16px' }}
                >
    ...
    const CategoriesMarquee = () => {
        ...
        const doubledCategories = [...categories, ...categories, ...categories, ...categories, ...categories, ...categories];

        return (
            <div className="overflow-hidden pointer-events-none w-full">
                <div 
                    className="h-full opacity-[0.6] animate-marquee-ltr items-center"
                    style={{ animationDuration: '30s', gap: '12px' }}
                >
    ...
    return (
        <>
            {/* BACKDROP - Uses CSS transitions instead of Framer Motion */}
            <div
                onClick={onClose}
            ...
            {/* SIDEBAR CONTAINER - Uses CSS transitions instead of Framer Motion */}
            <div
                className={`fixed left-0 top-0 z-[120] h-full w-[85%] max-w-[360px] bg-white shadow-2xl overflow-hidden flex flex-col transition-transform duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] ${
            ...
            >
                ...
                {/* NAVIGATION LINKS */}
                <div className="flex-1 overflow-y-auto px-[16px] py-[24px] scroll-gpu custom-scrollbar">
