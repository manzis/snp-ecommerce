            ...
            <div className="absolute top-[120px] left-0 right-0 z-10 px-4">
               <div className="rounded-[16px] overflow-hidden border border-[#EDF0E4] bg-white">
                  <CheckoutPriceHeader
                     ...
                     subtotal={Number(order.totalAmount || 0) + Number(order.coupon_discount || 0) + Number(order.bundle_discount || 0) - Number(order.shipping_amount || 0) - Number(order.cod_fees || 0)}
